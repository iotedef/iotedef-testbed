...
def analysis(h, a, r, d, m, ofprefix):
    ...
    for c in ["logistic_regression", "decision_tree", "random_forest", "feedforward", "lstm"]:
        ...
        print (">> Averaged Result (c: {}) <<".format(c))
...
def main():
    ...
    analysis(args.home, args.analyzer, args.round, args.dataset, args.maximum, args.output)
