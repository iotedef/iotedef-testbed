...
def analysis(h, c, a, r, d, m, ofprefix):
    ...
    print (">> Averaged Result (M: {}, R: {}, D: {}) <<".format(m, r, d))
...
def main():
    ...
    analysis(args.home, args.classifier, args.analyzer, args.round, args.dataset, args.maximum, args.output)
