...
def analysis(h, c, a, r, d, m, e, ofprefix):
    ...
    for st in [1, 2, 3]:
        ...
        for s in range(1, m+1):
            ids_fprefix = "{}/ids_{}_{}_st{}_r{}_d{}_e{}".format(h, c, a, st, r, d, e)
            ca_fprefix = "{}/ca_{}_{}_st{}_r{}_d{}_e{}".format(h, c, a, st, r, d, e)
        ...
        print (">> Averaged Result (st: {}) <<".format(st))
...
def command_line_args():
    ...
    parser.add_argument("-a", "--analyzer", metavar='<analyzer algorithm used>',
                        help='analyzer algorithm used', required=True)
    ...
    parser.add_argument("-e", "--edataset", metavar='<edataset number used>',
                        help='edataset number used', required=True)
...
def main():
    ...
    analysis(args.home, args.classifier, args.analyzer, args.round, args.dataset, args.maximum, args.edataset, args.output)
